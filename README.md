...
- `sort_vcf.q`: This was to sort vcf files for downstream analysis.


## Requirements

- samtools/1.19.2 # Tools for manipulating SAM/BAM files.
- bcftools/1.20.0 # Utilities for processing VCF/BCF files.
- vcflib/1.0.1 # Library for manipulating VCF files.
- vcftools/0.1.16 # Package for calculating population genetics statistics from VCF.
- htslib/1.9 # Library for high-throughput sequencing data formats.
- tassel/5.0 # Tool for analyzing and converting genotype data formats.
- salmon/1.5.0 # Tool for quantifying transcript abundance from RNA-seq data.
- fastp/0.20.1 # Fast all-in-one preprocessing tool for fastq files.
