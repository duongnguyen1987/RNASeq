...
# Usage: sbatch hisat2_alignment.sh
...
READS_DIR="/path/to/RNASeq_OCR/run2_analysis/merged/trimming/fastp-results"
...
echo "Alignment completed for sample ${IN_FILE_BASE}. Output BAM: $bam"
